...
<header id="header" class="header-separate header-4 logo-center <?php echo $search_size ?> sticky-menu-header<?php echo ($porto_settings['logo-overlay'] && $porto_settings['logo-overlay']['url']) ? ' logo-overlay-header' : '' ?>">
    ...
    <div class="header-main">
        <div class="container">
            <div class="header-left"><img src="<?php bloginfo('template_directory'); ?>/images/coat-guinea-logo.png">
                <?php
                // show search form
            ...
            <div class="header-right">			<div align="right"><?php  echo do_shortcode('[cn-social-icon]');?></div>
                <?php
